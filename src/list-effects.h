...
EFFECT(SWAP_PLACES,					false,	NULL,	0,		EFINFO_NONE,	"swap places with a target",	"swap places")
...
EFFECT(MOVE_ATTACK,					true,	"might",	1,		EFINFO_DICE,	"moves the player up to 4 spaces and executes a blow of up to x%d might",	"move and attack")
EFFECT(SINGLE_COMBAT,				true,	NULL,		0,		EFINFO_NONE,	"engages a monster in single combat",	"engage in single combat")
EFFECT(MELEE_BLOWS,					true,	"might",	1,		EFINFO_DICE,	"strikes a blow of x%d might against an adjacent monster",	"pummel")
EFFECT(SWEEP,						false,	"might",	1,		EFINFO_DICE,	"strikes a blow of x%d might against all adjacent monsters",	"sweep")
